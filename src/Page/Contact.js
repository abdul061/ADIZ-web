...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://appsail-50022714114.development.catalystappsail.in/contact', formData); // Make sure /contact route is used
      setsubmitText('sent')
      // Clear the form after successful submission
      setFormData({ name: '', email: '', message: '' });

      // Set a success message
      window.alert('Thank you for Contacting Adiz Codez !, kindly Check your mail for nore information !');
    } catch (error) {
